 ...
 * @param tree
 */
Tree.prototype.get_owner = function() {
 ...
 * @return {string} path
 */
Tree.prototype.get_path = function(node_id, tree){
    var that = this,
    path = [],
 ...
 * @return {Boolean}
 */
Tree.prototype.delete_all = function() {
    var first = this.tree[0];
    if ( first.root ) {
        first.tree = [];
        return true;
 ...
 * @param {object} tree
 */
Tree.prototype.count_nodes = function(count, tree) {
    var that = this;
 ...
 * @param tree
 */
Tree.prototype.insert = function(node_to_insert, node_id, tree){
    var that = this;
    if ( tree === undefined ) tree = that.tree;
 ...
 */
Tree.prototype.delete = function(node_id, tree){
    var that = this;
    var deleted = null;
    if ( tree === undefined ) tree = that.tree;
 ...
 * @return {Boolean}
 */
Tree.prototype.move = function(node_id, destination_id){
 ...
 * @return {Boolean}
 */
Tree.prototype.tree_contains = function(container_id, node_id){
 ...
 * @param tree
 */
Tree.prototype.fetch_node = function(node_id, tree) {
    var that = this;
    var _node = null;
    if ( tree === undefined ) tree = that.tree;
 ...
 * @return {Boolean}
 */
Tree.prototype.fetch_parent = function(node_id, container){
    var that   = this,
    parent = null;
 ...
 * @param node_id
     * @param tree
     */
Tree.prototype.toggle_user = function(add, user_name, node_id, tree) {
    var that = this;
    if ( node_id ) {
...
Tree.prototype.user_toggle =  function(add, node, user_name) {
 ...
 * @param node_id
 */
Tree.prototype.name_exists = function(node_or_id, parent_id){
    var _node;
...
Tree.prototype.node_exists = function(node_id, parent_id){
 ...
 * @param tree
 */
Tree.prototype.to_string = function(depth, tree){
    var name = '';
    var that = this;
    if ( tree === undefined ) tree = that.tree;
 ...
 */
Tree.prototype.to_html = function(depth, tree, result){
    var name = '';
    var that = this;
    if ( tree   === undefined ) tree = that.tree;
